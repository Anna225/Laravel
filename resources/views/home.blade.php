...
<div class="site-content main-content">
    <div class="swiper-container top-slider">
        <div class="swiper-wrapper">
            ...
            @forelse ( $homeSlides as $key => $slide )

                <div class="swiper-slide" style="background-image:url( {{ asset($slide->image_url) }} )">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                @else
                                    <a class="btn btn-primary mt-5" data-scrollreveal="enter bottom after 0.3s" target="{{ $slide->cta_target }}" href="{{ $slide->cta_link }}">
                                        {{ $slide->cta_label }}
                                        <i class="icon-arrow-right ml-2"></i>
                                    </a>
                                @endif
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 rightsquare reveal" data-scrollreveal="enter bottom after 0.3s">
                    <img src="{{ asset('images/about-us.jpg') }}" width="100%">
                </div>
                ...
                <div class="col-md-6 col-lg-5 ">
                    <div class="sec-title">
                        {{-- <p class="reveal" data-scrollreveal="enter bottom after 0.1s">What we are</p> --}}
    ...
    <div class="about-div">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 rightsquare reveal" data-scrollreveal="enter bottom after 0.3s">
                    <img src="{{ asset('images/first-aid-securtac.jpg') }}" width="100%">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-6 col-lg-4 reveal" data-scrollreveal="enter bottom after 0.3s">
                            <div class="service-plate">
                                <div class="service-top">
                                    <img src="{{ getServiceDetail(1,'image_url') }}" width="100%">
                                </div>
                                <div class="service-desc">
                                    <h3>{{ getServiceDetail(1,'name') }}</h3>
                                    ...
                                    <h4>${{ getServiceDetail(1,'price_without_tax') }}</h4>
                                </div>
                ...
                <div class="col-12 mb-5" id="first-aid-block">
                    <div class="row align-items-center reverse-row">
                        ...
                        <div class="col-md-6 col-lg-4 reveal" data-scrollreveal="enter bottom after 0.4s">
                            <div class="service-plate">
                                <div class="service-top">
                                    <img src="{{ getServiceDetail(2, 'image_url') }}" width="100%">
                                </div>
                                <div class="service-desc">
                                    <h3>{{ getServiceDetail(2, 'name') }}</h3>
                                    <p>{{ getServiceDetail(2, 'description') }}</p>
                                    <h4>${{ getServiceDetail(2, 'price_without_tax') }}</h4>
                                </div>
                                <div class="text-center bottom-alt">
                                    @if ( ! Auth::guard()->check() )
                                        <a href="{{ route('register', ['service' => 2]) }}">
                                            <button class="btn btn-primary btn-subscribe"> Enroll Now
                                                <i class="icon-arrow-right ml-2"></i>
                                            </button>
                                        </a>
                                    @elseif( ! isSubscribed( 2 ))
                                        <a href="{{ route('subscribe', 2 ) }}">
                                            <button class="btn btn-primary btn-subscribe"> Enroll Now
                                                <i class="icon-arrow-right ml-2"></i>
                                            </button>
                                        </a>
                                    @elseif( isSubscribed( 2 )->status == 'subscribed' )
                                        <a href="{{ route("schedule", 2 ) }}">
                ...
                <div class="col-12 mb-5">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-lg-4 reveal" data-scrollreveal="enter bottom after 0.4s">
                            <div class="service-plate">
                                <div class="service-top">
                                    <img src="{{ getServiceDetail(3, 'image_url') }}" width="100%">
                                </div>
                                <div class="service-desc">
                                    <h3>{{ getServiceDetail(3, 'name') }}</h3>
                                    <p>{{ getServiceDetail(3, 'description') }}</p>
                                    <h4>${{ getServiceDetail(3, 'price_without_tax') }}</h4>
                                </div>
                                <div class="text-center bottom-alt">
                                    @if ( ! Auth::guard()->check() )
                                        <a href="{{ route('register', ['service' => 3]) }}">
                                            <button class="btn btn-primary btn-subscribe"> Enroll Now
                                                <i class="icon-arrow-right ml-2"></i>
                                            </button>
                                        </a>
                                    @elseif( ! isSubscribed( 3 ))
                                        <a href="{{ route('subscribe', 3 ) }}">
                                            <button class="btn btn-primary btn-subscribe"> Enroll Now
                                                <i class="icon-arrow-right ml-2"></i>
                                            </button>
                                        </a>
                                    @elseif( isSubscribed( 3 )->status == 'subscribed' )
                                        <a href="{{ route("schedule", 3) }}">
                                            <button class="btn btn-primary btn-subscribe"> Schedule
                                                <i class="icon-arrow-right ml-2"></i>
                                            </button>
                                        </a>
                ...
                <div class="col-12 mb-5">
                    <div class="row align-items-center reverse-row">
                        ...
                        <div class="col-md-6 col-lg-4 reveal" data-scrollreveal="enter bottom after 0.4s">
                            <div class="service-plate">
                                <div class="service-top">
                                <img src="{{ asset('images/first_aid_2_days.jpg') }}" width="100%">
                                </div>
                                <div class="service-desc">
