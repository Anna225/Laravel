            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.slots.index', $scheduleSlot->service_id)); ?>">Schedule Slots</a></li>
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal" method="POST" action="<?php echo e(route('admin.slots.update', $scheduleSlot->id)); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input disabled type="text" class="form-control" id="input-service" value="<?php echo e($scheduleSlot->service->name); ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
...
endif; ?>" id="input-event" placeholder="Event Name" value="<?php echo e($scheduleSlot->event); ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="input-venue" placeholder="Venue Name" value="<?php echo e($scheduleSlot->venue); ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="input-sdate" placeholder="Start Date" value="<?php echo e(date('d-m-Y', strtotime($scheduleSlot->start_date))); ?>" autocomplete="off" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="date" id="input-time" data-target-input="nearest">
                                            <input type="text" name="start_time" class="form-control" placeholder="Select Time" data-target="#input-time" data-toggle="datetimepicker" autocomplete="off" value="<?php echo e($scheduleSlot->start_time); ?>" required>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="input-edate" placeholder="End Date" value="<?php echo e(date('d-m-Y', strtotime($scheduleSlot->end_date))); ?>" autocomplete="off" required>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="input-slots" placeholder="Total Slots" value="<?php echo e($scheduleSlot->total_slots); ?>" required>
...
if (isset($messageCache)) { $message = $messageCache; }
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <input type="hidden" name="service_id" value="<?php echo e($scheduleSlot->service_id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/securtac/public_html/securtac/resources/views/admin/schedule-slots/edit.blade.php ENDPATH**/ ?>