    ...
    <div class="site-part schedule-page">
        <div class="container">
            ...
            <div class="mt-30" id="slide-content">
                <button class="btn btn-primary start-study"><?php echo e($log->action_btn); ?></button>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var chapter_id   = '<?php echo e($chapter->id); ?>';
        var study_time   = '<?php echo e($chapter->study_time); ?>';
        var last_log     = '<?php echo e($log->last_time_log); ?>';
        var last_slide   = '<?php echo e($log->last_slide); ?>';
        var user_id      = '<?php echo e($user->id); ?>';
        var is_finished  = '<?php echo e($log->is_finished); ?>';
        var total_slides = '<?php echo e($chapter->slides_count); ?>';

        //var log_id       = '<?php echo e($chapter->log_id); ?>';
        ...
        $('#slide-content').on('click', '.start-study', function(){
            ...
            $.ajax({
                url: "<?php echo e(route('load_slides')); ?>",
                method: 'POST',
                data: data,
                cache: false,
            ...
            if ( $("#timer").data('seconds') < study_time  ) {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('finish_study')); ?>",
                            method: 'POST',
                            data: data,
                            cache: false,
                            success: function(result){
        ...
        function updateTimer(log_id){
            ...
            $.ajax({
                url: "<?php echo e(route('update_timer')); ?>",
                method: 'POST',
                data: data,
                cache: false,
                success: function(result){
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/securtac/public_html/securtac/resources/views/study.blade.php ENDPATH**/ ?>