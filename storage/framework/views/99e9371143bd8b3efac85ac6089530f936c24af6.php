        ...
        <div class="bread-top">
            <div class="container">
                <div class="sec-title disflexc">
                    <h1><?php echo e(($is_final) ? "Final Quiz" : $chapter->name.'- Quiz'); ?></h1>
        ...
        <div class="container pt-4 question-wrapper">
            <?php if($result): ?>
                <div class="alert alert-success" role="alert">
                    ...
                    <hr>
                    <p>Marks: <strong><?php echo e($result['correct_answers']); ?></strong>/<strong><?php echo e($result['total_questions']); ?></strong></p>
                    <p>Result:&nbsp;
                        <span class="badge 
                            ...
                            <?php else: ?>
                                badge-danger
                            <?php endif; ?>"><?php echo e($result['result_status']); ?></span></p>
                    <p>Percentage: <strong><?php echo e($result['percentage']); ?></strong></p>
                    <p>Time Spent:<strong class="result_time_spent" data-sec="<?php echo e($result['time_spent']); ?>"></strong></p>
                </div>
                <br>
                <?php echo html_entity_decode($result['result_data']); ?>

                <a class="btn btn-primary" href="<?php echo e(route('user.dashboard')); ?>">Go to Dashboard</a>
                <br><br>
            <?php else: ?>
                <div class="mt-60 btn-action">
                    <button class="btn btn-primary mw130 mb-3 start-quiz" data-type="<?php echo e(($is_final) ? 'final' : 'regular'); ?>">Start
...
<script src="<?php echo e(asset('plugins/Minimal-Stopwatch/timer.jquery.min.js')); ?>"></script>
...
$(document).ready(function(){
    ...
    var quizTimer;
    var chapter_id   = <?php echo e(($chapter) ? $chapter->id : 'null'); ?>

    var is_final     = <?php echo e($is_final); ?>
    ...
    $('.question-wrapper').on('click', '.start-quiz', function(){
        ...
        $.ajax({
            url: "<?php echo e(route('quiz.initialize')); ?>",
            method: 'POST',
            data: data,
            cache: false,
            success: function(result){
                ...
                if ( result.status == 'success' ) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('start.quiz')); ?>",
                        method: 'POST',
                        data: data,
                        cache: false,
                        success: function(result){
    ...
    $('.question-wrapper').on('click', '.btn-nav', function(){
        ...
        $.ajax({
            url: "<?php echo e(route('load.question')); ?>",
            method: 'POST',
            data: data,
            cache: false,
            success: function(result){
    ...
    $('.question-wrapper').on('click', '.btn-finish', function(){
        Swal.fire({
            ...
            onBeforeOpen: () => {
                ...
                $.ajax({
                    url: "<?php echo e(route('finish.quiz')); ?>",
                    method: 'POST',
                    data: data,
                    cache: false,
                    success: function(result){
    ...
    function updateTimer(quiz_id){
        ...
        $.ajax({
            url: "<?php echo e(route('quiz.timer')); ?>",
            method: 'POST',
            data: data,
            cache: false,
            success: function(result){
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/securtac/public_html/securtac/resources/views/quiz.blade.php ENDPATH**/ ?>