          ...
          <tr>
            <td class="email-body" width="570" cellpadding="0" cellspacing="0">
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td>
                    <img src="<?php echo e(asset('images/certificate-top.png')); ?>" width="600">
                  </td>
                </tr>
                <tr>
                  <td class="content-cell">
                    <div class="f-fallback">
                      <h1 style="text-align: center; font-size: 36px;"><?php echo e($data->first_name.' '.$data->last_name); ?></h1>
                                    ...
                                    <tr>
                                      ...
                                      <td align="right" style="width: 50%;">
                                        <div
                                          ...
                                          Signature
                                          <div style="height:15px;width:100%;line-height:15px;clear:both"></div>
                                          <img src="<?php echo e(asset('images/signature.png')); ?>" width="150px" alt="">
                                        </div>
                                      </td>
                                    </tr>
                                  </table>
                              ...
                              <tr>
                                <td>
                                  <div
                                    ...
                                    Provided by:
                                    <div style="height:15px;width:100%;line-height:15px;clear:both"></div>
                                    <img src="<?php echo e(asset('images/site-logo.png')); ?>" width="50px" alt="">
                                  </div>
                                </td>
                                <td>
...
</html><?php /**PATH /home2/securtac/public_html/securtac/resources/views/emails/certificate.blade.php ENDPATH**/ ?>