            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo e(route('admin.clients.store')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
...
if (isset($messageCache)) { $message = $messageCache; }
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="link" type="url" class="form-control <?php if ($errors->has('link')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('link'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="input-link" placeholder="Client Logo Link" value="<?php echo e(old('link')); ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    <!-- /.content -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/securtac/public_html/securtac/resources/views/admin/clients/create.blade.php ENDPATH**/ ?>