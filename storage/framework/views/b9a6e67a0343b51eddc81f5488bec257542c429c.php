                        ...
                        <div class="col-7 col-sm-9">
                            <div class="tab-content" id="vert-tabs-tabContent">
                                <div class="tab-pane text-left fade active show" id="vert-tabs-general" role="tabpanel" aria-labelledby="vert-tabs-general-tab">
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo e(route('admin.settings')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <img src="<?php echo e(asset($options->site_logo ?? '')); ?>" class="img-thumbnail" width="100">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <img src="<?php echo e(asset($options->site_favicon ?? '')); ?>" class="img-thumbnail" width="60">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <a href="<?php echo e(asset($options->consent_form ?? '')); ?>">Current Form</a>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="final_questions" class="col-sm-3 col-form-label">Questions for final quiz</label>
                                                <div class="col-sm-9">
                                                    <input type="number" name="total_final_questions" class="form-control" id="final_questions" value="<?php echo e($options->total_final_questions ?? ''); ?>">
                                                    <small class="text-muted">Total questions for final quiz. (can not be more than <?php echo e($totalQuestions); ?>)</small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="final_questions" class="col-sm-3 col-form-label">Min. Passing Marks</label>
                                                <div class="col-sm-9">
                                                    <input type="number" name="final_pass_marks" class="form-control" id="final_questions" value="<?php echo e($options->final_pass_marks ?? ''); ?>">
                                                    <small class="text-muted">Minimum marks to pass final quiz. (Can not be more than <?php echo e($totalQuestions); ?>)</small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="google_tag_id" class="col-sm-3 col-form-label">Google Tag Id</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="google_tag_id" class="form-control" id="google_tag_id" value="<?php echo e($options->google_tag_id ?? ''); ?>">
                                    ...
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo e(route('admin.settings')); ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="url" name="facebook_link" class="form-control" id="facebook_link" value="<?php echo e($options->facebook_link ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="twitter_link" class="col-sm-3 col-form-label">Twitter</label>
                                                <div class="col-sm-9">
                                                    <input type="url" name="twitter_link" class="form-control" id="twitter_link" value="<?php echo e($options->twitter_link ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="instagram_link" class="col-sm-3 col-form-label">Instagram</label>
                                                <div class="col-sm-9">
                                                    <input type="url" name="instagram_link" class="form-control" id="instagram_link" value="<?php echo e($options->instagram_link ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="linkedin_link" class="col-sm-3 col-form-label">Linkedin</label>
                                                <div class="col-sm-9">
                                                    <input type="url" name="linkedin_link" class="form-control" id="linkedin_link" value="<?php echo e($options->linkedin_link ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="offset-sm-3 col-sm-9">
                                    ...
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo e(route('admin.settings')); ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="public_address" class="form-control" id="public_address" value="<?php echo e($options->public_address ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="public_phone" class="col-sm-3 col-form-label">Phone</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="public_phone" class="form-control" id="public_phone" value="<?php echo e($options->public_phone ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="public_email" class="col-sm-3 col-form-label">Public Email</label>
                                                <div class="col-sm-9">
                                                    <input required type="text" name="public_email" class="form-control" id="public_email" value="<?php echo e($options->public_email ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="admin_email" class="col-sm-3 col-form-label">Admin Address</label>
                                                <div class="col-sm-9">
                                                    <input required type="text" name="admin_email" class="form-control" id="admin_email" value="<?php echo e($options->admin_email ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="offset-sm-3 col-sm-9">
                                    ...
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo e(route('admin.settings')); ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="referral_heading" class="form-control" id="referral_heading" value="<?php echo e($options->referral_heading ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="referral_subheading" class="col-sm-3 col-form-label">Sub Heading</label>
                                                <div class="col-sm-9">
                                                    <textarea name="referral_subheading" class="form-control" id="referral_subheading"> <?php echo e($options->referral_subheading ?? ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="offset-sm-3 col-sm-9">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/securtac/public_html/securtac/resources/views/admin/settings.blade.php ENDPATH**/ ?>