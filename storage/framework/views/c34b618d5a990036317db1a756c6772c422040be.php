...
endif; ?>" placeholder="First Name*" id="first-name" autocomplete="first-name">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Last Name*" id="last-name" autocomplete="last-name">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Email Address*" id="email">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group col-12">
                                        <input type="number" name="mobile_number" class="form-control <?php if ($errors->has('mobile_number')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mobile_number'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="inputMobile" placeholder="Phone Number">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group col-12">
                                        <input type="text" name="birth_date" id="inputDate" class="form-control birth_date <?php if ($errors->has('birth_date')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('birth_date'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Birthday*" autocomplete="off">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group col-12">
                                        <input type="text" class="form-control <?php if ($errors->has('address_line_1')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('address_line_1'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="address_line_1" placeholder="Street Number & Street Name" required>
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group col-12">
                                        <input type="text" class="form-control <?php if ($errors->has('address_line_2')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('address_line_2'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="address_line_2" placeholder="Apartment/Unit Number">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group col-12 col-sm-6">
                                        <input required type="text" class="form-control <?php if ($errors->has('city')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('city'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="city" placeholder="City">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group col-12 col-sm-6">
                                        <input required type="text" class="form-control <?php if ($errors->has('state')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('state'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="state" placeholder="Province/State">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group col-12 col-sm-6">
                                        <input required type="text" class="form-control <?php if ($errors->has('postal_code')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('postal_code'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="postal_code" placeholder="Postal Code">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group col-12">
                                    <input type="hidden" class="form-control <?php if ($errors->has('referral_code')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('referral_code'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="referral_code" placeholder="Referral Code" value="<?php echo e($referralCode); ?>" autocomplete="off">
                                    </div>
                                ...
                                <div class="card-header choice-acc" id="headingOne" data-toggle="collapse"
                                    ...
                                    <h6 class="mb-0 disflexc">
                                        <label class="custom-checkbox fw-700">
                                            <span class="check-label"><?php echo e($services[0]->name); ?></span>
                                            <input class="service-checkbox" data-price="<?php echo e($services[0]->price); ?>" type="checkbox" name="services[]" value="1" <?php if(request()->has('service') && request()->get('service') == '1' ): ?> checked <?php endif; ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                        <span class="price-acc"><sup>$</sup><?php echo e($services[0]->price_without_tax); ?></span>
                                    </h6>
                                </div>

                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    data-parent="#accordionExample">
                                    <div class="card-body acc-body"><?php echo e($services[0]->description); ?></div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header choice-acc" id="headingTwo" data-toggle="collapse"
                                    ...
                                    <h6 class="mb-0 disflexc">
                                        <label class="custom-checkbox fw-700">
                                            <span class="check-label"><?php echo e($services[1]->name); ?></span>
                                            <input class="service-checkbox" data-price="<?php echo e($services[1]->price); ?>" type="checkbox" name="services[]" value="2" <?php if(request()->has('service') && request()->get('service') == '2' ): ?> checked <?php endif; ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                        <span class="price-acc"><sup>$</sup><?php echo e($services[1]->price_without_tax); ?></span>
                                    </h6>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                    data-parent="#accordionExample">
                                    <div class="card-body acc-body"><?php echo e($services[1]->description); ?></div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header choice-acc" id="headingThree" data-toggle="collapse"
                                    ...
                                    <h6 class="mb-0 disflexc">
                                        <label class="custom-checkbox fw-700">
                                            <span class="check-label"><?php echo e($services[2]->name); ?></span>
                                            <input class="service-checkbox" data-price="<?php echo e($services[2]->price); ?>" type="checkbox" name="services[]" value="3" <?php if(request()->has('service') && request()->get('service') == '3' ): ?> checked <?php endif; ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                        <span class="price-acc"><sup>$</sup><?php echo e($services[2]->price_without_tax); ?></span>
                                    </h6>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                    data-parent="#accordionExample">
                                    <div class="card-body acc-body"><?php echo e($services[2]->description); ?></div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/securtac/public_html/securtac/resources/views/auth/register.blade.php ENDPATH**/ ?>