...
<html>
  ...
  <body>
    <span class="preheader"><?php echo e($data->user->name); ?> has invited you to get on SECURTAC.</span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hello there!</h1>
                        <p><?php echo e($data->user->name); ?> has invited you to get on SECURTAC. Use the button below to set up your account and get started:</p>
                        <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="<?php echo e($data->action_url); ?>" class="f-fallback button" target="_blank">Set up account</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                        ...
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
                              ...
                              <p class="f-fallback sub"><?php echo e($data->action_url); ?></p>
                            </td>
                          </tr>
                        </table>
                      </div>
...
</html><?php /**PATH /home2/securtac/public_html/securtac/resources/views/emails/invite.blade.php ENDPATH**/ ?>